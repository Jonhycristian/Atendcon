...
const AtendconSPA = () => {
  usePageSeo({
    title: "Contabilidade para Veterinários e Pet Shops em BH | AtendCon",
    description: "Contabilidade especializada para clínicas veterinárias, pet shops e hospitais veterinários em BH: menos impostos e controle financeiro. Solicite consultoria.",
    path: "/veterinarios",
    faqs,
    preloadImage: "/fundo06.webp",
  });
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-600 selection:text-white relative overflow-x-hidden w-full">
      ...
      <section className="relative min-h-[100dvh] flex flex-col justify-center pt-28 pb-16 md:pt-36 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0 bg-slate-900">
          <img src="/fundo06.webp" alt="Clínica veterinária atendida pela contabilidade especializada AtendCon" fetchPriority="high" decoding="async" className="w-full h-full object-contain md:object-cover object-top md:object-center" />
      ...
      <section id="sobre" className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[450px] md:h-[500px] w-full group bg-slate-900">
            <img src="/fundo06.webp" alt="Equipe AtendCon especialista em contabilidade veterinária" loading="lazy" decoding="async" className="w-full h-full object-contain md:object-cover object-top md:object-center md:group-hover:scale-105 transition-transform duration-700" />
      ...
      <section id="faq" ref={faqRef} className="py-24 bg-[#020617] text-white relative overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20 mix-blend-screen">
          <img src="/fundo02.webp" alt="Perguntas frequentes sobre contabilidade para veterinários" loading="lazy" decoding="async" className="w-full h-full object-cover" />
        </div>
